        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComoLlego = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductorResponsableId = table.Column<int>(type: "int", nullable: false),
                    HorasContratadas = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proyectos_AspNetUsers_ProductorResponsableId",
                        column: x => x.ProductorResponsableId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tarifas_Proyectos_ProyectoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proyectos_ProductorResponsableId",
                table: "Proyectos",
                column: "ProductorResponsableId");

            migrationBuilder.CreateIndex(
                name: "IX_Tarifas_ProyectoId",
                table: "Tarifas",
                column: "ProyectoId",
                unique: true);
        }
